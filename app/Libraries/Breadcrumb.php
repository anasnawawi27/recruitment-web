...
class Breadcrumb {
    ...
    public function __construct() {
        ...
        $this->tags['liopenactive'] = '<li class="breadcrumb-item active">';
        $this->tags['licloseactive'] = '</li>';
    }
    ...
    public function render() {
        ...
        foreach($this->breadcrumbs as $index => $breadcrumb) {
            ...
            if($index == $count){
                $output .= $this->tags['liopenactive'];
                $output .= $breadcrumb['crumb'];
                $output .= $this->tags['licloseactive'];
            }elseif($breadcrumb['href']=='#') {
    ...
    public function buildAuto() {
        ...
        foreach($crumbs as $k => $crumb) {
            ...
            $name = ucwords(str_replace(array(
                ".php",
                "_"
            ), array(
                "",
